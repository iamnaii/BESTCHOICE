...
const SECTIONS: TermSection[] = [
  ...
  {
    icon: <FileCheck className="size-6" aria-hidden="true" />,
  ...
  },
  {
    ...
    paragraphs: [
      'เครื่องผ่อนทุกเครื่องติดตั้งระบบดูแลเครื่อง (MDM) ตามมาตรฐานร้านผ่อน ระบบนี้ไม่เข้าถึงรูปถ่าย ข้อความ หรือแอปส่วนตัวของคุณ — ใช้เพื่อดูแลสถานะเครื่องระหว่างผ่อน และระบุพิกัดเครื่องได้เฉพาะกรณีจำเป็นตามสัญญา เช่น เครื่องสูญหายหรือค้างชำระ',
  ...
  {
    icon: <BadgePercent className="size-6" aria-hidden="true" />,
  ...
  },
  {
    ...
    bullets: [
      'แจ้งเตือนก่อนถึงกำหนด 5, 3 และ 1 วัน ทาง LINE (ปิด/เปิดการแจ้งเตือนทั้งชุดได้เองใน LINE)',
