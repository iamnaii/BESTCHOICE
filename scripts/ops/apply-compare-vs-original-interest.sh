#!/usr/bin/env bash
# v3.4 ต่างกันยังไง = เทียบกับรุ่นที่สนใจแรก — รัน apply-compare-vs-original-interest.sql
# — รัน apply-compare-vs-original-interest.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-compare-vs-original-interest.sql || die "apply ล้มเหลว"
