#!/usr/bin/env bash
# ปลด AI ที่โดนปิดจากข้อความทักทายอัตโนมัติ — รัน clear-handoff-whitelist-rooms.sql
# — รัน clear-handoff-whitelist-rooms.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/clear-handoff-whitelist-rooms.sql || die "apply ล้มเหลว"
