#!/usr/bin/env bash
# v2.15 สำนวนคำถามทำความรู้จัก — รัน apply-discovery-phrasing.sql
# — รัน apply-discovery-phrasing.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-discovery-phrasing.sql || die "apply ล้มเหลว"
