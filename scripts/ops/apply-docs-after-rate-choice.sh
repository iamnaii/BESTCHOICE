#!/usr/bin/env bash
# v2.10 เลือกเรทแล้วขอเอกสารเช็ค — รัน apply-docs-after-rate-choice.sql
# — รัน apply-docs-after-rate-choice.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-docs-after-rate-choice.sql || die "apply ล้มเหลว"
