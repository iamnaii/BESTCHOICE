...
BESTCHOICE เป็นระบบ **Hire-Purchase / ผ่อนชำระ** สำหรับร้านขายมือถือในประเทศไทย:
...
- ขายเงินสด (CASH), ผ่อน (INSTALLMENT, จำนวนงวดตั้งค่าได้, flat rate), ผ่านไฟแนนซ์ภายนอก (EXTERNAL_FINANCE / GFIN)
- ระบบค่าใช้จ่ายพร้อม workflow อนุมัติ
- รายงาน P&L, Aging Report, Entity Profit
- ปิดบัญชีทุกสิ้นเดือน, นำส่ง VAT ภายในวันที่ 15 ของเดือนถัดไป
- ส่งรายงาน: ภ.พ.30 (รายเดือน), ภ.ง.ด.3/53 (รายเดือน), ภ.ง.ด.50/51 (รายปี), งบการเงิน (DBD รายปี)
...
- กำไร SHOP = ดาวน์ + ยอดจัด + ค่าคอม - ต้นทุน
- กำไร FINANCE = ดอกเบี้ยรวม - ค่าคอม (ต้องจ่าย VAT)

### จบสัญญา
1. ผ่อนครบ → กรรมสิทธิ์โอนลูกค้าอัตโนมัติ
2. Early Payoff → ลด 50% ดอกเบี้ยคงเหลือ
3. ส่งเครื่องคืน/ยึดเครื่อง → ตัดขาดทุน → FINANCE ขายเครื่องให้ SHOP ราคาตลาด
4. ยึดไม่ได้ → ติดตาม → จดหมาย → ส่งฟ้อง → ตัดหนี้สูญ (360+ วัน)
