        ...
        <Card className="border-border/60 shadow-sm">
          <CardHeader>
            <div className="flex items-center gap-2">
              <svg className="size-4 text-warning-strong" fill="currentColor" viewBox="0 0 20 20">
        ...
        <CardContent>
          ...
          {selectedProduct ? (
            <div className="flex items-center justify-between bg-muted rounded-lg p-3">
              ...
              <button onClick={onClearProduct} className="text-xs text-destructive hover:underline">
                เปลี่ยน
              </button>
            </div>
          ) : (
