#!/usr/bin/env bash
# v5.0 บอกสีที่มี + กันยาวเมื่อหลายสี — รัน apply-show-colors-v5-0.sql
# — รัน apply-show-colors-v5-0.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-show-colors-v5-0.sql || die "apply ล้มเหลว"
