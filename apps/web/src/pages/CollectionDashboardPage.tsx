...
const AGING_COLORS = [
  ...
  { bg: 'bg-warning/10 dark:bg-warning/15', bar: 'bg-warning', text: 'text-warning-strong', border: 'border-warning/20' },
  { bg: 'bg-warning/20 dark:bg-warning/25', bar: 'bg-warning', text: 'text-warning-strong', border: 'border-warning/40' },
  { bg: 'bg-warning/20 dark:bg-warning/25', bar: 'bg-warning', text: 'text-warning-strong', border: 'border-warning/40' },
