#!/usr/bin/env bash
# v2.4 เรทที่ 1/เรทที่ 2 ไม่เอ่ยชื่อช่องทาง — รัน apply-rate-names-neutral.sql
# — รัน apply-rate-names-neutral.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-rate-names-neutral.sql || die "apply ล้มเหลว"
