#!/usr/bin/env bash
# v4.0.x แพตช์อ่านง่าย 3 จุด — รัน apply-readability-fixes-v4-0-x.sql
# — รัน apply-readability-fixes-v4-0-x.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-readability-fixes-v4-0-x.sql || die "apply ล้มเหลว"
