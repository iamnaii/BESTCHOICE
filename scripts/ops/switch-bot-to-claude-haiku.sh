#!/usr/bin/env bash
# สลับบอทขาย Gemini → Claude Haiku 4.5 — รัน switch-bot-to-claude-haiku.sql
# — รัน switch-bot-to-claude-haiku.sql (เขียนทับทั้งก้อนแบบ md5-guard)
# รัน:  bash scripts/ops/switch-bot-to-claude-haiku.sh
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/switch-bot-to-claude-haiku.sql || die "apply ล้มเหลว"
