...
- **ไม่มี migration ใน batch นี้** (B0 = `20260985000000`, B3 = `20260983000000`; ถ้าจำเป็นต้องมีจริงให้เช็ค max ก่อนเสมอ — B1 ไม่ควรมี)
