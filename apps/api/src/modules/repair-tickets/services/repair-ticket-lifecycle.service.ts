...
/**
 * Lifecycle (write) half of RepairTicketsService.
 * Owns ALL 10 $transaction blocks + every write + the cross-module draft
 * creation. Constructed internally by the RepairTicketsService facade.
 */
@Injectable()
export class RepairTicketLifecycleService {
  constructor(
