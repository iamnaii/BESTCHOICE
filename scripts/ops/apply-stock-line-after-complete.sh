#!/usr/bin/env bash
# v2.9 "กำลังเข้ามา+จอง" พูดตอนบอกเรทหลังถามครบ — รัน apply-stock-line-after-complete.sql
# — รัน apply-stock-line-after-complete.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-stock-line-after-complete.sql || die "apply ล้มเหลว"
