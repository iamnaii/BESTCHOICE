#!/usr/bin/env bash
# v2.5 บอกความต่างสองเรทพร้อมกับตัวเลขเสมอ — รัน apply-rate-difference-explain.sql
# — รัน apply-rate-difference-explain.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-rate-difference-explain.sql || die "apply ล้มเหลว"
