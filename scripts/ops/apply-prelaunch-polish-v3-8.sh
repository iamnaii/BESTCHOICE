#!/usr/bin/env bash
# (ดูหัวไฟล์ .sql) — รัน apply-prelaunch-polish-v3-8.sql
# — รัน apply-prelaunch-polish-v3-8.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-prelaunch-polish-v3-8.sql || die "apply ล้มเหลว"
