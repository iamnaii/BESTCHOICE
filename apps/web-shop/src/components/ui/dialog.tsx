...
const dialogContentVariants = cva(
  'flex flex-col fixed outline-hidden z-50 border border-border bg-background p-6 shadow-lg shadow-black/5 duration-[var(--duration-medium)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 rounded-2xl',
  {
    variants: {
      variant: {
