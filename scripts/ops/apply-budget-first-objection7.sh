#!/usr/bin/env bash
# v2.20 Objection7 ราคาไม่รู้รุ่น → ถามงบดาวน์ — รัน apply-budget-first-objection7.sql
# — รัน apply-budget-first-objection7.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-budget-first-objection7.sql || die "apply ล้มเหลว"
