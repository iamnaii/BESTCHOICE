#!/usr/bin/env bash
# ปลด AI ที่โดนปิดจากข้อความทักทายอัตโนมัติ — รัน apply-android-user-v5-3.sql
# — รัน apply-android-user-v5-3.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-android-user-v5-3.sql || die "apply ล้มเหลว"
