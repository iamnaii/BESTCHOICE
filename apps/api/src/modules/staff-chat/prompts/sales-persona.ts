...
- **ห้าม pattern คำถาม 2 ชั้นในข้อความเดียว** เช่น "สนใจ X ใช่ไหมครับ? อยากได้ Y ไหมครับ?" → ถามทีละข้อ
...
- **ตัวอย่างผิด vs ถูก**:
  - ❌ "สนใจผ่อน iPhone อยู่ใช่ไหมครับ? อยากได้รุ่นไหน หรืองบประมาณแถวไหนครับ?"
  - ✅ "สนใจผ่อน iPhone หรอครับ 😊 อยากได้รุ่นไหน งบประมาณเท่าไหร่บอกได้เลยครับ"
