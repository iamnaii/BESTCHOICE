#!/usr/bin/env bash
# v4.1 emoji นำหน้าการ์ด (เจ้าของเลือก) — รัน apply-card-emoji-v4-1.sql
# — รัน apply-card-emoji-v4-1.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-card-emoji-v4-1.sql || die "apply ล้มเหลว"
