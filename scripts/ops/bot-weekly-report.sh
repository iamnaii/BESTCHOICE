#!/usr/bin/env bash
# รายงานบอทรายสัปดาห์ — รัน bot-weekly-report.sql
# — รัน bot-weekly-report.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/bot-weekly-report.sql || die "apply ล้มเหลว"
