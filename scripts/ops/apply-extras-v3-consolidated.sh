#!/usr/bin/env bash
# v3 EXTRAS รื้อรวม 7 หมวด — รัน apply-extras-v3-consolidated.sql
# — รัน apply-extras-v3-consolidated.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-extras-v3-consolidated.sql || die "apply ล้มเหลว"
