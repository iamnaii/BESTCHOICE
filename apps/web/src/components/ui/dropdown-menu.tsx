...
function DropdownMenuSubTrigger({
  ...
  return (
    ...
    >
      {children}
      <ChevronRight data-slot="dropdown-menu-sub-trigger-indicator" className="ml-auto size-3.5!" />
    </DropdownMenuPrimitive.SubTrigger>
  );
}
  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          'space-y-0.5 z-50 min-w-32 overflow-hidden rounded-md border border-border bg-popover p-2 text-popover-foreground shadow-md shadow-[#1e3a5f]/5 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2',
          className,
        )}
        {...props}
      />
...
function DropdownMenuRadioItem({
  ...
  return (
    <DropdownMenuPrimitive.RadioItem
      ...
      className={cn(
        'relative flex cursor-default select-none items-center rounded-md py-1.5 pl-6 pr-2 text-sm outline-hidden transition-colors focus:bg-accent focus:text-accent-foreground data-disabled:pointer-events-none data-disabled:opacity-50',
        className,
      )}
      {...props}
    >
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      className={cn('px-2 py-1.5 text-xs text-muted-foreground font-medium', inset && 'pl-8', className)}
      {...props}
    />
  );
}
