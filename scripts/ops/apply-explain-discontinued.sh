#!/usr/bin/env bash
# v2.8 รุ่นนอกรายการมือ 1 บอกเหตุผล "มือ 1 ไม่มีผลิตแล้ว" — รัน apply-explain-discontinued.sql
# — รัน apply-explain-discontinued.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-explain-discontinued.sql || die "apply ล้มเหลว"
