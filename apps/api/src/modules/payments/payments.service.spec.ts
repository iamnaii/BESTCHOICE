...
describe('PaymentsService', () => {
  ...
  describe('previewJournal', () => {
    ...
    it('includes late fee line (42-1103) when lateFee > 0', async () => {
      ...
      // P2-4: amountReceived is the FULL cash the cashier collects (installment + late
      // fee), mirroring the save (orchestrator delta = amount). The preview no longer
      // adds late fee on top — so the cashier sends installment(2202.41) + lateFee(54).
      const lateFee = 54;
