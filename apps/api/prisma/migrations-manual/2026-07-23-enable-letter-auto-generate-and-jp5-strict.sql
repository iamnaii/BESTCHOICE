...
--   SystemConfig flags flip from "off" to enforced:
--
...
--   2. Confirm with the OWNER that both flags read 'true'.
...
\echo ''
\echo 'This will set BOTH keys above to value = ''true'' (legal review passed,'
\echo 'owner approval 2026-07-24). Abort here if that is not intended.'
\echo ''
