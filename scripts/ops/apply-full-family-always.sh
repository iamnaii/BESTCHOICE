#!/usr/bin/env bash
# v2.6 ลิสต์รุ่นย่อยเต็มชุดเสมอ — รัน apply-full-family-always.sql
# — รัน apply-full-family-always.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-full-family-always.sql || die "apply ล้มเหลว"
