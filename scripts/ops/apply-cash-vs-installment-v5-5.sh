#!/usr/bin/env bash
# ปลด AI ที่โดนปิดจากข้อความทักทายอัตโนมัติ — รัน apply-cash-vs-installment-v5-5.sql
# — รัน apply-cash-vs-installment-v5-5.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-cash-vs-installment-v5-5.sql || die "apply ล้มเหลว"
