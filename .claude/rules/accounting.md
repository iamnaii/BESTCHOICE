...
> **✅ CPA ตอบครบแล้ว 2026-08-26 — แก้โค้ดแล้ว (ปิดประเด็นนี้)**
>
...
- **ห้ามลง JV มือทับสามบัญชีนี้โดยไม่รู้ตัว:** ไม่มีเลนส์ระหว่างกิจการอ่าน จึงปลอดภัยสำหรับ JV — แต่ `S11-1104`/`S11-1105` จะ**สะสมขึ้นเรื่อย ๆ**
  เพราะยังไม่มีเมนูบันทึกว่าเจ้าของนำเงินไปฝาก/ใช้จ่ายต่อ (ต้องลง JV `Dr ธนาคาร / Cr S11-1104` เอง) — งานถัดไปถ้าเจ้าของต้องการ
