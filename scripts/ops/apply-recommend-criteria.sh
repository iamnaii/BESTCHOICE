#!/usr/bin/env bash
# v2.11 เกณฑ์เลือกรุ่นแนะนำ (ดาวน์นำ) — รัน apply-recommend-criteria.sql
# — รัน apply-recommend-criteria.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-recommend-criteria.sql || die "apply ล้มเหลว"
