...
export class SettingsController {
  ...
  /** D1.1.1.2 — joined list for admin UI. */
  @Get('role-map')
  ...
  /**
   * D1.1.1.3 + D1.1.1.6 — Update a role mapping. Audit log records
   * either `ROLE_MAP_UPDATED` or `ROLE_MAP_DEACTIVATED` depending on
   * whether `isActive` flipped true → false.
   */
  @Put('role-map/:id')
  @Roles('OWNER')
  updateRoleMap(
