#!/usr/bin/env bash
# v4.4 เก็บกวาดพรอมป์ต (ลบซ้ำ+รวมกฎขัดกัน) — รัน apply-prompt-cleanup-v4-4.sql
# — รัน apply-prompt-cleanup-v4-4.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-prompt-cleanup-v4-4.sql || die "apply ล้มเหลว"
