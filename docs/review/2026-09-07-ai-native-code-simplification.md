...
สถานะ ณ 8 กันยายน 2026: ทำหน้าเริ่มงานพนักงานขาย, lazy settings, ส่วนกลาง AI ข้อความ และสูตรค่างวดกลางแล้วใน branch `codex/ai-native-staff-experience` ดู [ผลการทำงานและหลักฐานทดสอบ](2026-09-08-ai-native-implementation.md) ส่วนเครดิต/OCR/Inbox ที่ทับกับอีก session รอรวมงานก่อนดำเนินการต่อ ยังไม่ได้ deploy การเปลี่ยนแปลงนี้
