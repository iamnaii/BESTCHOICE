...
- รั้ว (`assertSameTestSide`) ที่ POS / เปิดสัญญา / ใบจอง / **เปลี่ยนเครื่องระหว่างสัญญา** (ทั้งตอนส่งคำขอ
  และตอนอนุมัติ) / **เคลมเปลี่ยนเครื่องตำหนิ** (รวมทาง replace จากใบซ่อม) **จะไม่ให้**ขายหรือสลับเครื่อง `TEST-` ให้ลูกค้าจริง
...
รั้ว (POS / เปิดสัญญา / ใบจอง / เปลี่ยนเครื่อง / เคลมเปลี่ยนเครื่อง) + auto-mark เทิร์น + ด่าน 5 ของ factory reset ต้องอยู่บน prod
