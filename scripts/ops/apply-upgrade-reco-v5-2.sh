#!/usr/bin/env bash
# ปลด AI ที่โดนปิดจากข้อความทักทายอัตโนมัติ — รัน apply-upgrade-reco-v5-2.sql
# — รัน apply-upgrade-reco-v5-2.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-upgrade-reco-v5-2.sql || die "apply ล้มเหลว"
