#!/usr/bin/env bash
# v4.7 ปิดเคสก้ำกึ่ง + ปลดล็อกกฎห้ามถามเงินซ้ำ — รัน apply-edge-cases-v4-7.sql
# — รัน apply-edge-cases-v4-7.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-edge-cases-v4-7.sql || die "apply ล้มเหลว"
