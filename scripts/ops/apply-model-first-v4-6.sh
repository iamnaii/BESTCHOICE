#!/usr/bin/env bash
# v4.5+v4.6 "สนใจ" = ถามรุ่นก่อน + แก้ของซ้ำ — รัน apply-model-first-v4-6.sql
# — รัน apply-model-first-v4-6.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-model-first-v4-6.sql || die "apply ล้มเหลว"
