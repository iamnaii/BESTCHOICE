...
- This command's default preview covers Inbox, credit, offers, and contract handoff with synthetic data/AI. For other features, also run the appropriate app/API locally from this checkout and exercise the changed flow; do not claim this limited preview validates the whole application.
