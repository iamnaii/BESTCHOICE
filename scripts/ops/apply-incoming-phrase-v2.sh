#!/usr/bin/env bash
# v2.7 สต๊อกว่าง = "ของกำลังเข้ามา" — รัน apply-incoming-phrase-v2.sql
# — รัน apply-incoming-phrase-v2.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-incoming-phrase-v2.sql || die "apply ล้มเหลว"
