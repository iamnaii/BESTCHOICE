#!/usr/bin/env bash
# v2.2 บังคับถามรุ่นย่อยเสมอ — รัน apply-ask-submodel-always.sql
# — รัน apply-ask-submodel-always.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-ask-submodel-always.sql || die "apply ล้มเหลว"
