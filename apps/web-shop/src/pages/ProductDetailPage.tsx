...
export default function ProductDetailPage() {
  ...
  return (
    <ShopLayout>
      ...
      {/* B5 T12b: หมดสต็อกแล้วไม่มีเครื่องให้เลือกงวด — การ์ดนี้ยังคำนวณค่างวดจาก
         data.installmentPrice ของ head record ซึ่งอาจไม่ null แม้ 0 หน่วยพร้อมขาย
         และ CTA ของมัน (ทักแชทผ่อนเครื่องนี้) จะชวนคุยเครื่องที่ขายไปแล้ว
