/**
 * Knowledge Base seed entries — single source of truth.
 * Used by: seed controller, seed script, local dev seeder.
 */
export const KB_SEED_ENTRIES = [
  {
    intent: 'product_iphone', category: 'product',
    ...
    responseType: 'auto', requiresAuth: false, priority: 70,
  },
  {
    intent: 'product_ipad', category: 'product',
    triggerKeywords: ['iPad', 'ไอแพด', 'แท็บเล็ต'],
    exampleQuestions: ['มี iPad ไหม'],
    responseTemplate: 'เรามี iPad มือ1 (ใหม่จาก Apple) ค่ะ\n✅ บัตรประชาชนใบเดียว\n✅ ไม่เช็คเครดิตบูโร\n✅ อนุมัติ 15 นาที',
    responseType: 'auto', requiresAuth: false, priority: 65,
  },
  {
    intent: 'android_redirect', category: 'product',
    ...
    responseType: 'auto', requiresAuth: false, priority: 85,
  },
  {
    intent: 'ipad_used_redirect', category: 'product',
  ...
  {
    intent: 'installment_documents', category: 'onboarding',
    ...
    responseType: 'auto', requiresAuth: false, priority: 80,
  },
  {
    intent: 'complaint', category: 'escalation',
    triggerKeywords: ['ร้องเรียน', 'ไม่พอใจ', 'complaint', 'ผิดหวัง'],
    exampleQuestions: ['ขอร้องเรียน'],
    responseTemplate: 'ขอโทษที่ทำให้ไม่สะดวกนะคะ 🙏\nกำลังส่งเรื่องให้ผู้จัดการดูแลโดยตรง\nติดต่อกลับภายใน 24 ชม.\n📞 063-134-6356',
    responseType: 'handoff', requiresAuth: false, priority: 95,
  },
  {
    intent: 'payment_method', category: 'payment',
    ...
    responseType: 'auto', requiresAuth: false, priority: 75,
  },
  {
    intent: 'late_fee_explain', category: 'payment',
  ...
  {
    intent: 'early_payoff_info', category: 'payment',
    ...
    responseType: 'handoff', requiresAuth: true, priority: 70,
  },
];
