    ...
    <div>
      <PageHeader
        ...
        action={
          <button
            onClick={openCreate}
            className="inline-flex items-center gap-1.5 px-4 py-2 bg-[#059669] text-white hover:bg-[#047857] shadow-[0_2px_8px_rgba(5,150,105,0.25)] rounded-lg text-sm font-medium"
          >
