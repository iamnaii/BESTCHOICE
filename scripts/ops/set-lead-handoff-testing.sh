#!/usr/bin/env bash
# ปลด AI ที่โดนปิดจากข้อความทักทายอัตโนมัติ — รัน set-lead-handoff-testing.sql
# — รัน set-lead-handoff-testing.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/set-lead-handoff-testing.sql || die "apply ล้มเหลว"
