#!/usr/bin/env bash
# v2.13 เทิร์นเรท 3 ก้อน + ก้อนสุดท้ายจัดบรรทัด — รัน apply-rate-turn-3-bubbles.sql
# — รัน apply-rate-turn-3-bubbles.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-rate-turn-3-bubbles.sql || die "apply ล้มเหลว"
