...
test('CI collects the isolated credit specs exactly once, outside the shared service database suite', () => {
  ...
  for (const file of ['chat-credit-check.e2e-spec.ts', 'credit-approval.e2e-spec.ts', 'credit-payment-flow.e2e-spec.ts', 'staff-offer.e2e-spec.ts', 'trade-in-buyback.e2e-spec.ts']) {
