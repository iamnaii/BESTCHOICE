...
> **อัปเดต 2026-09-20:** ค่าคอมสัญญาผ่อนทำแล้ว (PR #1612 — ตั้งตอนเปิดใช้สัญญา) และ `createInstallmentSale` ถูกลบแล้ว ⇒ แถว
> "POS ผ่อนในเครือ (เส้นทางเก่า)" ในตารางจุดเขียน tender ด้านบนไม่มีอยู่จริงอีกต่อไป — `CONTRACT_DOWN` มาจากหน้าสัญญาทางเดียว.
