import { UserRole, ContractStatus, ContractWorkflowStatus, ProductStatus, PaymentMethod, PlanType, ProductCategory, PaymentStatus, SaleType, POStatus, POPaymentStatus, ReceivingItemStatus, TransferStatus, InspectionScoreType, ConditionGrade, SignerType, NotificationChannel, RepossessionStatus, StockAdjustmentReason, CreditCheckStatus, ContractDocumentType } from './constants';
