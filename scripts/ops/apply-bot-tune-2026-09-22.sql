...
SELECT CASE WHEN md5(value) = 'b9faece1adf448559b5ea1ac4dd267f2' THEN '✓' ELSE '✗' END || ' EXTRAS ตรงฉบับที่คาดทุกตัวอักษร len=' || length(value) FROM system_config WHERE key='shop_bot_persona_bot_extras' AND deleted_at IS NULL;
