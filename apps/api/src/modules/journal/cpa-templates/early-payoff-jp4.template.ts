 ...
 *   settlementAmount   = remainingGross - discount + remainingDeferredVat
 *
...
export class EarlyPayoffJP4Template {
  ...
  async execute(
    ...
    // Settlement amount customer pays
