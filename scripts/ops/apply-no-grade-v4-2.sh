#!/usr/bin/env bash
# v4.2-4.3 ไม่พูดเกรด (บอกแบต%) + bullet รายการ — รัน apply-no-grade-v4-2.sql
# — รัน apply-no-grade-v4-2.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-no-grade-v4-2.sql || die "apply ล้มเหลว"
