...
ออกแบบใบสำคัญจ่ายซ้ำตามคำขอใช้ `ui-ux-pro-max`: หัวเอกสารแสดงชื่อ และย้ายยอดเด่นลงใต้ตารางรายการพร้อมจำนวนเงินตัวอักษรตามคำขอเจ้าของ ใช้ IBM Plex Sans Thai ที่มีอยู่ ตารางเส้นบาง และระยะห่างสำหรับ A4 โดยเก็บรูปแบบชื่อไฟล์ไทยเดิม รายละเอียดผลค้นและการตรวจฟอนต์ในไฟล์ build อยู่ใน [บันทึกใบสำคัญจ่าย](2026-09-08-payment-voucher-redesign.md)

### คำรับรองผู้ขายก่อนรับซื้อ/เทิร์น — 8 กันยายน 2026

เพิ่มคำรับรองห้าข้อให้เห็นก่อนลงนาม เก็บข้อความรุ่นที่ลงนามพร้อมหลักฐานและแสดงฉบับนั้นใน PDF โดยไม่เปลี่ยนใบเก่า ป้องกันการเขียนทับหลักฐานจากการรับเครื่องซ้ำ แก้ canvas ว่างและการนำลายเซ็นกลับมาใช้หลังย้อนแก้ข้อมูล มี migration SHOP แบบ nullable ไม่มี backfill; API 111, PostgreSQL แยก 35 และ local:check 17 checks ผ่าน รายละเอียดข้อกฎหมาย ขั้นตอนตรวจรับที่ยังต้องทำจริง และข้อจำกัด: [คำรับรองผู้ขาย](2026-09-08-seller-declaration.md)

เพิ่ม IMEI/Serial Number แยกช่องในหน้ารับซื้อและก่อนลงนามรับเครื่อง ส่งต่อสองค่าไปยังสินค้าและแสดงแยกใน PDF โดยใช้ข้อมูลของรายการรับซื้อ ค่าว่างในใบเก่าแสดง “ไม่ระบุ” มี migration SHOP แบบ nullable ไม่มี backfill รายละเอียดและผลตรวจอยู่ใน [บันทึกใบสำคัญจ่าย](2026-09-08-payment-voucher-redesign.md)

### Trade-in: ปิดงานรับซื้อซ้ำ หลักฐาน เครดิต และ CI

ดำเนินงานสี่ข้อที่เจ้าของอนุมัติ พร้อมคุมเครดิตใช้ครั้งเดียว แยกโบนัสส่วนลด/มูลค่าเครื่อง/เงินสดใน POS สัญญา รายงาน และเอกสาร รายละเอียด migration พฤติกรรมยกเลิก ข้อจำกัด และการตรวจจริง: [Trade-in rollout](2026-09-08-trade-in-credit-rollout.md)
