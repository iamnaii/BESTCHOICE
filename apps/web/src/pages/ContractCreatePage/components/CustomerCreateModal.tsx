            ...
            <div className="rounded-xl border border-border bg-card p-5">
              <div className="flex items-center gap-2.5 mb-4">
                ...
                <button
                  ...
                  className="px-4 py-2 text-sm bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 disabled:opacity-50 font-medium transition-colors"
                >
              ...
              {cardReaderLoading && (
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-sm text-emerald-600">กำลังอ่านข้อมูลจาก Smart Card...</div>
                </div>
              )}
            </div>
