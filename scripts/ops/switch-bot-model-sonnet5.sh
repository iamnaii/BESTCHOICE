#!/usr/bin/env bash
# อัปเกรดโมเดลบอทขายเป็น Sonnet 5 — รัน switch-bot-model-sonnet5.sql
# — รัน switch-bot-model-sonnet5.sql (เขียนทับทั้งก้อนแบบ md5-guard)
# รัน:  bash scripts/ops/switch-bot-model-sonnet5.sh
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/switch-bot-model-sonnet5.sql || die "apply ล้มเหลว"
