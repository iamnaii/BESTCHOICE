import { ListTodo, Clock, CalendarDays, AlertCircle, CheckCircle2, Search } from 'lucide-react';
...
export function TodoFilters({ view, onViewChange, search, onSearchChange, tabCounts }: TodoFiltersProps) {
  return (
    <>
      {/* Tabs (pill style) */}
