...
ออกแบบใบสำคัญจ่ายซ้ำตามคำขอใช้ `ui-ux-pro-max`: เปลี่ยนเป็นหัวเอกสารพร้อมยอดเด่นด้านบน ใช้ IBM Plex Sans Thai ที่มีอยู่ ตารางเส้นบาง และระยะห่างสำหรับ A4 โดยเก็บรูปแบบชื่อไฟล์ไทยเดิม รายละเอียดผลค้นและการตรวจฟอนต์ในไฟล์ build อยู่ใน [บันทึกใบสำคัญจ่าย](2026-09-08-payment-voucher-redesign.md)
