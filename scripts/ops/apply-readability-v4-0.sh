#!/usr/bin/env bash
# v4.0-2 เขียนให้อ่านง่าย (คำสั่งเจ้าของ) — รัน apply-readability-v4-0.sql
# — รัน apply-readability-v4-0.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-readability-v4-0.sql || die "apply ล้มเหลว"
