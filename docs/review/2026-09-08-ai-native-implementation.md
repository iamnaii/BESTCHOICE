...
### ปรับรับซื้อและเทิร์นเครื่อง — 8 กันยายน 2026

แยกการจ่ายเงินให้ผู้ขายออกจากเครดิตเทิร์น แก้ Quick Buy ให้เป็น BUYBACK และลงบัญชี SHOP ถูกเส้นทาง ใช้ช่องข้อมูลสภาพเครื่องร่วมกับ PO และเพิ่มทางส่งต่อไปจัดรูป/ราคาก่อนเข้าคลัง `local:check` ตรวจ flow นี้ทั้งจอใหญ่และมือถือด้วยบริการจริงบนฐานตัวอย่าง รายละเอียด สาเหตุ และข้อจำกัดเรื่องการนำเครดิตไปหักยอดอยู่ใน [บันทึกการปรับ flow รับซื้อ](2026-09-08-trade-in-purchase-flow.md)
...
ปรับการส่งออกใบสำคัญให้ใช้ชื่อไทยพร้อมเลขเอกสาร เปิดดูและดาวน์โหลดไฟล์เดียวกันในโปรแกรม และตรวจชื่อไฟล์ดาวน์โหลดจริงทั้งคอมและมือถือแล้ว รายละเอียดอยู่ในบันทึกใบสำคัญจ่ายด้านบน
