...
BEGIN
  ...
  IF md5(ex) <> 'b9faece1adf448559b5ea1ac4dd267f2' THEN RAISE EXCEPTION 'EXTRAS บน DB ไม่ใช่ฉบับที่คาด (ฉบับ 2026-09-22 — มีคนแก้ persona หลัง apply) md5=%', md5(ex); END IF;
