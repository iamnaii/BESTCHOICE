...
### คำถามถึงเจ้าของ (ห้ามเดาแล้วสร้าง flow เอง)
...
**ต้องให้เจ้าของเคาะ:** (ก) ยอมรับช่องว่างนี้ (บันทึกขายผิด = ให้ผู้ดูแลระบบแก้ฐานข้อมูล
เป็นราย ๆ) หรือ (ข) ทำ flow "ยกเลิกใบขาย" จริง — ซึ่งต้องออกแบบครบชุด: กลับสถานะสินค้า +
