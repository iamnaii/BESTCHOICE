#!/usr/bin/env bash
# v2.12 เทิร์นเรทแบ่งก้อนทยอยส่ง — รัน apply-rate-turn-bubbles.sql
# — รัน apply-rate-turn-bubbles.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-rate-turn-bubbles.sql || die "apply ล้มเหลว"
