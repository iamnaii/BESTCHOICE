#!/usr/bin/env bash
# v2.14 วลีขอเอกสาร → รู้ผลไวใน 5 นาที — รัน apply-doc-check-phrase.sql
# — รัน apply-doc-check-phrase.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/apply-doc-check-phrase.sql || die "apply ล้มเหลว"
