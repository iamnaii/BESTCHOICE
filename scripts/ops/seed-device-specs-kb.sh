#!/usr/bin/env bash
# v3.3 คลังสเปคต่อรุ่น + กฎสเปคจาก KB — รัน seed-device-specs-kb.sql
# — รัน seed-device-specs-kb.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/seed-device-specs-kb.sql || die "apply ล้มเหลว"
