...
# ซึ่งมาจากแหล่งความจริงเดียว packages/shared/src/facebook-webhook-fields.ts
# (มี message_echoes = ข้อความที่พนักงานตอบจากกล่องข้อความของเพจ — ขาดแล้วห้องค้าง "รอตอบ")
