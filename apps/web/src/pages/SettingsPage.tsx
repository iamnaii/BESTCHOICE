    ...
    <div>
      ...
      <div className="flex flex-col gap-5 lg:gap-7.5">
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-4 flex items-center justify-between">
          <div>
            <div className="text-sm font-medium text-green-800">เชื่อมต่อ LINE OA</div>
            <div className="text-xs text-green-600 mt-0.5">เชื่อมต่อ LINE Official Account เพื่อส่งแจ้งเตือนค่างวด, สลิปชำระเงิน และติดตามหนี้ผ่าน LINE</div>
          </div>
