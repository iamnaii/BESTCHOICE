#!/usr/bin/env bash
# ปลด AI ที่โดนปิดจากข้อความทักทายอัตโนมัติ — รัน clear-stale-resolved-at.sql
# — รัน clear-stale-resolved-at.sql (เขียนทับทั้งก้อนแบบ md5-guard)
...
psql "$PGURL" -v ON_ERROR_STOP=1 -f scripts/ops/clear-stale-resolved-at.sql || die "apply ล้มเหลว"
