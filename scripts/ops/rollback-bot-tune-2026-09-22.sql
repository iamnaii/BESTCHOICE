...
BEGIN
  ...
  IF md5(ex) <> '5c84b08565310b396103bae1170c5b1c' THEN RAISE EXCEPTION 'EXTRAS บน DB ไม่ใช่ฉบับที่คาด (ฉบับ 2026-09-22 — มีคนแก้ persona หลัง apply) md5=%', md5(ex); END IF;
